...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		System.out.printf("오늘 %d년 %d월 %d일  %n", nowYear, nowMonth, nowDate);

		
		//날짜의 연산
		//10년뒤로 이동
		Calendar future = Calendar.getInstance(); //year에 10 더해주기
		future.add(Calendar.YEAR, 10);
		System.out.printf("10년 후 : %d년 %d월 %d일 %n",future.get(Calendar.YEAR)
