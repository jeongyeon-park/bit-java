package com.javaec.api.collection.hash;
...
public class HashtableEx {
	...
	public static void main(String[] args) {
		...
		//데이터 변경 : put  : 같은 키로 덮어쓰기. (이미 있는 키면)
		map.put("202", new Classroom("C#", "R202"));
...
//		System.out.println("Java: " + map.containsValue("Java")); .타입이 안맞음
		System.out.println("Java강의 포함? "+
				map.containsValue(new Classroom("Java")));
		//hashCode, equals가 적절히 오버라이드 되어ㅣ있어야 정상 작동한다. 
